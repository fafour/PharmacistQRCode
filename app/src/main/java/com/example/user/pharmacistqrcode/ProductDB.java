...
public class ProductDB extends ContentProvider {
    ...
    public class MyDatabase extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            String sql = "CREATE TABLE products ("+COL_ID+" INTEGER PRIMARY KEY AUTOINCREMENT,icon INTEGER, productname TEXT,  timeDate TEXT)";
            db.execSQL(sql);
